...
const Home = () => {
  ...
  return (
    <div className="home container">
      ...
      <Banner />
      <div className="titleHome">Top bán chạy</div>
      <div className="bestSaller">{bestSaller()}</div>
      <div className="titleHome">Sách thịnh hành</div>
      <div className="bookHot">{booksHot()}</div>
      <div className="titleHome">Sách mới</div>
      <div className="bookNew">{booksNew()}</div>
    </div>
  );
};
